...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Flex - Free Responsive Template by templatemo</title>
    ...
    <body>
        ...
        <div class="site-main" id="sTop">
            <div class="site-header">
                ...
                <div class="main-header">
                    <div class="container">
                        <a href="#"> <img class="LogoDVG" src="images/logo.png" /></a>
                        <div id="menu-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-10 col-xs-4 main-menu text-right">
                                    <ul class="menu-first hidden-sm hidden-xs">
                                        ...
                                        <li><a href="#contato">A Empresa</a></li>
                        ...
                        <ul class="slides">
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    ...
                                    <p>Mais segurança para seu imóvel. &nbsp&nbsp&nbsp&nbsp Mais Tranquilidade para você.</p>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="portfolio-item col-md-6 col-sm-6">
                        <div class="portfolio-thumb">
                            <h3>Monitoramente de Alarmes</h3>
                            <img src="images/gallery/p1.jpg" alt="Monitoramente de Alarmes">
                            <div class="portfolio-overlay">
                                <h3>Monitoramente de Alarmes</h3>
                                <p>Em decorrência dos inúmeros casos de roubos e furtos que acompanhamos diariamente no Brasil e no Mundo, o alarme torna-se não mais uma escolha, e sim uma necessidade para o cidadão que deseja ter o seu patrimônio protegido.

                                    Um sistema de alarme precisa ser definido de acordo com a rotina e especificidades de cada imóvel. Por isso, ele passa por uma avaliação completa de levantamento de pontos vulneráveis por um de nossos consultores especializados...</p>
        ...
        <div class="content-section" id="solucoes">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
        ...
        <div class="content-section" id="contato">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Contact Us</h2>
